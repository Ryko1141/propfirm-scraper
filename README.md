...
Then open **http://localhost:8010/** to use the new Guardian Compliance Studio UI. It ships with a responsive form for firm/program metadata, account metrics, and open positions, plus real-time status badges, breach chips, and soft-rule coaching cards.
